    ...
    <div className="grid grid-cols-2 md:flex md:flex-nowrap gap-8 lg:absolute bottom-0 left-0 md:divide-x mt-20 lg:mt-0">
      <Link href="/open-startup">
        <div className="flex flex-col md:pr-8 text-center">
          <h4 className="text-[#878787] text-sm mb-4">People Helped</h4>
          <span className="text-2xl font-mono text-stroke">200+</span>
        </div>
      </Link>
      <Link href="/open-startup">
        <div className="flex flex-col md:px-8 text-center">
          <h4 className="text-[#878787] text-sm mb-4">New Learners Joined</h4>
      ...
      <Link href="/open-startup">
        <div className="flex flex-col md:px-8 text-center">
          ...
          <span className="text-2xl font-mono text-stroke">75k</span>
        </div>
      </Link>
      <Link href="/open-startup">
        <div className="flex flex-col md:px-8 text-center">
          <h4 className="text-[#878787] text-sm mb-4">Loss Percent</h4>
          <span className="text-2xl font-mono text-stroke">2.1%</span>
        </div>
      </Link>
    </div>
  );
